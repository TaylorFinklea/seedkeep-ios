...
`main` — TestFlight 0.4.0 build 52; M2 exact 1.0.0 build 53 candidate local/dirty.
...
- [ ] Freeze/commit/push source; run `scripts/release.sh --major` once; push 1.0.0/53 bump.
